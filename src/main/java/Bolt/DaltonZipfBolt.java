...
public class DaltonZipfBolt extends BaseWindowedBolt {
    ...
    public DaltonZipfBolt(int parallelism, int slide, int size, int numOfKeys, int batchSize) {
    ...
    public void execute(TupleWindow tupleWindow) {
        for (Tuple tuple : tupleWindow.get()){
            ...
            int chosenTask = chooseWorker(Integer.valueOf(key), collector);
